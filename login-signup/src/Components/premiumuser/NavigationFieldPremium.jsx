...
import './NavigationFieldPremium.css';  // Import file CSS tùy chỉnh
import 'bootstrap/dist/css/bootstrap.min.css'; // Import Bootstrap

const NavigationFieldPremium = () => {
  return (
    <div>
      ...
      <div className={`nav-field d-none d-lg-flex flex-column align-items-center p-4`}>
        ...
        <div className="nav-buttons d-flex flex-column justify-content-center align-items-start w-100">
          ...
          <Link to="/premiumprofile" className="nav-item active"> {/* Điều hướng đến trang Profile */}
            <img src="https://static-00.iconduck.com/assets.00/profile-icon-512x512-w0uaq4yr.png" alt="profile" className="icon"/>
            <span className='nav-text'>Profile</span>
          </Link>
          <Link to="/settingspremium" className="nav-item active"> {/* Điều hướng đến trang Settings */}
      ...
      <div className="nav-field-horizontal d-lg-none">
        ...
        <Link to="/premiumprofile" className="nav-item-horizontal active"> {/* Điều hướng đến trang Profile */}
          <img src="https://img.icons8.com/parakeet-line/48/FFFFFF/gender-neutral-user.png" alt="profile"/>
          {/* <span>Profile</span> */}
        </Link>
        <Link to="/settingspremium" className="nav-item-horizontal active"> {/* Điều hướng đến trang Settings */}
          <img src="https://img.icons8.com/parakeet-line/48/FFFFFF/settings.png" alt="settings"/>
          {/* <span>Settings</span> */}
        </Link>
        <Link to="/viewwholikeyou" className="nav-item-horizontal active"> {/* Điều hướng đến trang Profile */}
          <img src="https://img.icons8.com/ios/50/FFFFFF/visible--v1.png" alt="likedList"/>
          {/* <span>LikedList</span> */}
        </Link>
...
export default NavigationFieldPremium;
