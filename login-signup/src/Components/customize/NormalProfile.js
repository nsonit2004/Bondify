...
import { FaEdit, FaLock } from "react-icons/fa"; // Importing a pencil and close icons
import "./Profile.css";
    ...
    return (
        <div className="main-container">
          ...
          />
            ...
            <Modal show={showPremiumPopup} onHide={handleClose} centered>
                <Modal.Header closeButton>
                    <Modal.Title>Premium Feature</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    This feature is available for premium users. Please upgrade to access it.
                </Modal.Body>
                <Modal.Footer>
                    <Button variant="secondary" onClick={handleClose}>
                        Close
                    </Button>
                    <Button variant="primary" onClick={() => window.location.href = '/premium'}>
                        Go Premium
                    </Button>
                </Modal.Footer>
            </Modal>
